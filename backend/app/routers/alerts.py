...
# Importing Moses's read-only models
from app.models.water_source import WaterSource
from app.models.water_reading import WaterReading
from app.schemas import AlertResponse
# Importing Alvin's read-only utility
...
async def get_active_alerts(
    ...
    for source in nearby_sources:
        ...
        for alert_type in triggered_alert_types:
            ...
            # If an identical alert was sent within 6 hours, suppress/throttle it
            ...
            # 6. Append to the final payload returned to Fidel's frontend client
